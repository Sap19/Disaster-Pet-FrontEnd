		...
		return (
			<div style={{ paddingTop: "60px" }}>
				...
				<div style={{ paddingRight: "20%", paddingLeft: "20%", paddingTop: '1%' }}>
					<h1 style={{ border: "1px solid", borderRadius: "16px" }}>{i18n.t("manageAnimalTypes.title")}</h1>
				</div>
					...
					<div classname="row">
						<Form.Field className="optionColumn">
							<Input
								...
								placeholder={i18n.t("manageAnimalTypes.search")}
							/>
						</Form.Field>
						<Form.Field className="optionColumn">
							<Dropdown
						...
						<Table striped>
							<Table.Header>
								<Table.Row>
									...
									<Table.HeaderCell>{i18n.t("manageAnimalTypes.name")}</Table.HeaderCell>
								</Table.Row>
							</Table.Header>
